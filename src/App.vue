    ...
    <div class="container">
      ...
      <section class="section contact">
        ...
        <div class="contact-links">
          ...
          <a href="mailto:syafiq@example.com" class="contact-link">
            <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
              <path
...
<script setup>
// Static page for now; add Vue logic here later if needed.
</script>

<style scoped>
/* Component-scoped overrides could go here if needed. */
</style>
